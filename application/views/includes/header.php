<style type="text/css">
    ...
    #mob_nav { top: 60px; position: fixed; width: 100%; z-index: 999; background: #FFF; border-bottom: 1px solid #EEE;  }
...
<header class="m_header g_row0 <?php echo in_array($nav,['pembayaran'])?'sticky fix':''; ?>">
    <a href="<?php echo base_url(); ?>" class="g_v_mid"><img class="lg1" src="<?php echo base_url(); ?>public/assets/img/logo.png"><img class="lg2" src="<?php echo base_url(); ?>public/assets/img/logo_black.png"></a>
    <nav class="g_right nav_right hidden-xs">
        <ul>
            ...
            <li><a href="<?php echo base_url(); ?>gift_vouchers">Gift Vouchers</li>
            <li><a href="javascript:void(0);">Help</a></li>
        </ul>
    </nav>
    <a id="mob_menu" href="javascript:void(0);" class="hidden-lg hidden-md- hidden-sm"><span class="menu-trigger"></span></a>
</header>
<div id="mob_nav" class="navbar-collapse" style="display:none;">
    <ul class="nav navbar-nav navbar-right">
        <li><a href="javascript:void(0);">Search</a></li>
        <li><a href="<?php echo base_url(); ?>experience">Experience</a></li>
        <li><a href="<?php echo base_url(); ?>gift_vouchers">Gift Vouchers</a></li>
        <li><a href="javascript:void(0);">Help</a></li>
    </ul>
</div>